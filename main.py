...
if __name__ == "__main__":
    ...
    text = "Есть много примеров, когда нет явного согласования между антецедентами и анафорами: К сожалению, ни один наш оператор не может обеспечить устойчивых связей: они имеют дело с радиорелейными станциями на земле, а нужны спутниковые возможности, компании, которые могут предоставлять спутниковые услуги."
